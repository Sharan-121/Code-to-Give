import 'package:app/followups.dart';
                  ...
                  if (widget.language == "English") {
                    Navigator.pushReplacement(
                      ...
                      PageRouteBuilder(
                        ...
                        pageBuilder: (context, animation, secondaryAnimation) =>
                            AttendedSessionsPage(widget.userToken,
                                "\u0939\u093f\u0928\u094d\u0926\u0940"),
                        transitionsBuilder:
                    ...
                    Navigator.pushReplacement(
                      ...
                      PageRouteBuilder(
                        transitionDuration: const Duration(milliseconds: 0),
                        pageBuilder: (context, animation, secondaryAnimation) =>
                            AttendedSessionsPage(widget.userToken, "English"),
                        transitionsBuilder:
                            (context, animation, secondaryAnimation, child) {
                          var begin = const Offset(1.0, 0.0);
                          var end = Offset.zero;
      ...
      onPressed: () {
        Navigator.pushReplacement(
          ...
          PageRouteBuilder(
            ...
            pageBuilder: (context, animation, secondaryAnimation) =>
                FollowUpPage(widget.userToken, widget.language, widget.data),
            transitionsBuilder:
                (context, animation, secondaryAnimation, child) {
              var begin = const Offset(1.0, 0.0);
              var end = Offset.zero;
              ...
              Padding(
                  ...
                  child: RichText(
                    ...
                    children: [
                      TextSpan(
                        text:
                            widget.language == "English" ? "Date: " : "तारीख: ",
                        style: const TextStyle(
                            fontFamily: 'Montserrat',
                            color: Colors.white,
                            fontSize: 15,
